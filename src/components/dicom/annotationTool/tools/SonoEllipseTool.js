...
import pointInEllipse from '../util/ellipse/pointInEllipse'
import calculateEllipseStatistics from '../util/ellipse/calculateEllipseStatistics'
...
const logger = getLogger('tools:annotation:SonoEllipseTool');

/**
 * @public
 * @class SonoEllipseTool
 * @memberof Tools.Annotation
 * @classdesc Tool for drawing elliptical regions of interest, and measuring
 * the statistics of the enclosed pixels.
 * @extends Tools.Base.BaseAnnotationTool
 */
export default class SonoEllipse extends BaseAnnotationTool {
  constructor(props = {}) {
    const defaultProps = {
      name: 'SonoEllipse',
...
function _createTextBoxContent(
  ...
  textInfo.push(_formatArea(area, hasPixelSpacing));
  otherLines.forEach(x => textInfo.push(x));
