...
import insertOrDelete from '../util/freehand/insertOrDelete'
...
const logger = getLogger('tools:annotation:FreeHandTool');
 ...
 */
export default class FreeHand extends BaseAnnotationTool {
  constructor(props = {}) {
    const defaultProps = {
      name: 'FreeHand',
  ...
  _getMouseLocation(eventData) {
    ...
    // cornerstoneTools.clipToBox(config.mouseLocation.handles.start, image);
